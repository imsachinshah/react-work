...
function Todos() {
  ...
  // const [isTodoEditable, setIsTodoEditable] = useState(todos.map(() => false));
  // const [updateTodoValue, setUpdateTodoValue] = useState(todos.map(() => ""));
            ...
            >
              ...
              {/* <button
                ...
                onClick={() => {
                  ...
                  if (isTodoEditable) {
                    dispatch(updateTodo({id: todo.id, text: updateTodoValue}))
                  } else setIsTodoEditable((prev) => !prev);
                }}
                disabled={todo.completed}
              >
